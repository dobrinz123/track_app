...
PART = {
    ...
    "J2": "JST B2B-PH-K-S  C131337 (hand-solder)", "J3": "1x8 2.54 pad row (DNP)",
    "SW1": "BOOT  TS-1187A C318884", "SW2": "RESET  TS-1187A C318884",
    "SW3": "POWER  SS-12D00-G3 C22355741 (hand-solder)",
    "RT1": "10k NTC B3380  C13564", "LED1": "yellow C2287", "LED2": "red C2286", "LED3": "red C2286 (CHG)",
...
IC_PINS = {
    "U1": [("3", "3V3", "L"), ("45", "EN", "L"), ("4", "IO0/BOOT", "L"), ("5", "IO1/ADC1_0", "L"),
           ("6", "IO2", "L"), ("12", "IO8/SDA", "L"), ("13", "IO9/SCL", "L"), ("14", "IO10", "L"),
           ("15", "IO11", "L"), ("16", "IO12", "L"), ("17", "IO13", "L"), ("9", "IO5", "L"),
           ("10", "IO6", "L"), ("11", "IO7", "L"), ("18", "IO14", "L"),
           ("23", "IO19/D-", "R"), ("24", "IO20/D+", "R"), ("25", "IO21", "R"), ("34", "IO38/U1TX", "R"),
           ("35", "IO39/U1RX", "R"), ("36", "IO40", "R"), ("37", "IO41", "R"), ("39", "TXD0", "R"),
           ("40", "RXD0", "R"), ("27", "IO47", "R"), ("30", "IO48", "R"), ("7", "IO3 strap", "R"),
